...
The `penmscan` package contains functions to build Elastic Network Models (ENM) of
...
# Installation
Install packages `penmscan` (this package) and `jefuns` (miscelaneous functions, some of which `penmscan` uses).
